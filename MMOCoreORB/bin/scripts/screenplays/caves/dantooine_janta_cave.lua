...
function JantaCaveScreenPlay:spawnMobiles()
	--spawnMobile("dantooine", "janta_clan_leader",900,-91.6,-100.4,-93.6,-178,529333) -- this one
	...
	spawnMobile("dantooine", "janta_herbalist",900,-96.6,-102.4,-138.3,103,529330) -- this one
	spawnMobile("dantooine", "janta_herbalist",900,-87.6,-101.9,-136.5,163,529330) --this one
	...
	spawnMobile("dantooine", "janta_loreweaver",900,-28.7,-80.1,-148.5,11,529332) --this one
	...
	spawnMobile("dantooine", "janta_rockshaper",900,-21.5,-79.5,-143.4,-32,529332) --this one
	...
	spawnMobile("dantooine", "janta_scout",900,-94.5,-101.9,-143.1,87,529330) -- this one
	...
	spawnMobile("dantooine", "janta_shaman",900,-26.1,-70.9,-148.2,-46,529332) --this one
	...
	spawnMobile("dantooine", "janta_warrior",900,-84.9,-100.1,-97.2,-109,529333) -- this one
	spawnMobile("dantooine", "janta_warrior",900,-98,-100.5,-100.5,79,529333) -- this one
end
