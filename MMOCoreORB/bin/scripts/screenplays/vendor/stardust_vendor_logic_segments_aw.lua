...
StardustAWSEGVendorLogic = ScreenPlay:new {
	scriptName = "StardustAWSEGVendorLogic",
	--EXAMPLE SETUP
	currencies = {
...
registerScreenPlay("StardustAWSEGVendorLogic", false)

function StardustAWSEGVendorLogic:openSUIArmorweaveSegments(pCreatureObject, pUsingObject)
...
function StardustAWSEGVendorLogic:defaultCallbackArmorweaveSegments(pPlayer, pSui, eventIndex, args)
...
function StardustAWSEGVendorLogic:buyItemArmorweaveSegments(pPlayer, itemSelected)
...
function StardustAWSEGVendorLogic:getMerchandiseStringArmorweaveSegments(num)
...
function StardustAWSEGVendorLogic:hasEnoughCurrencyArmorweaveSegments(pPlayer, num)
	local pInventory = CreatureObject(pPlayer):getSlottedObject("inventory")
	local containerSize = SceneObject(pInventory):getContainerObjectsSize()
	local pGhost = CreatureObject(pPlayer):getPlayerObject()
...
function StardustAWSEGVendorLogic:payTokensArmorweaveSegments(pPlayer, selectedItem, num)
	local pInventory = CreatureObject(pPlayer):getSlottedObject("inventory")
	local containerSize = SceneObject(pInventory):getContainerObjectsSize()
	local pGhost = CreatureObject(pPlayer):getPlayerObject()
