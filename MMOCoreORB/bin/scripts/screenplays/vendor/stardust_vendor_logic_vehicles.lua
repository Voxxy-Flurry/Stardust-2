...
StardustVehicleVendorLogic = ScreenPlay:new {
	scriptName = "StardustVehicleVendorLogic",
	--EXAMPLE SETUP
	currencies = {
		...
		{name = "AV-21 Schematic", template = "object/tangible/loot/loot_schematic/corellian_corvette_landspeeder_av21_schematic.iff", cost = {10, 0, 0, 0, 0, 0}},
		{name = "STAP Speeder", template = "object/tangible/deed/vehicle_deed/speeder_stap_deed.iff", cost = {5, 0, 0, 0, 0, 0}},
		},
}

registerScreenPlay("StardustVehicleVendorLogic", false)

function StardustVehicleVendorLogic:openSUIvehicles(pCreatureObject, pUsingObject)
	...
	sui.setTitle("Vehicles Merchandise")
...
function StardustVehicleVendorLogic:defaultCallbackVehicles(pPlayer, pSui, eventIndex, args)
...
function StardustVehicleVendorLogic:buyItemVehicles(pPlayer, itemSelected)
...
function StardustVehicleVendorLogic:getMerchandiseStringVehicles(num)
...
function StardustVehicleVendorLogic:hasEnoughCurrencyVehicles(pPlayer, num)
	local pInventory = CreatureObject(pPlayer):getSlottedObject("inventory")
	local containerSize = SceneObject(pInventory):getContainerObjectsSize()
	local pGhost = CreatureObject(pPlayer):getPlayerObject()
...
function StardustVehicleVendorLogic:payTokensVehicles(pPlayer, selectedItem, num)
	local pInventory = CreatureObject(pPlayer):getSlottedObject("inventory")
	local containerSize = SceneObject(pInventory):getContainerObjectsSize()
	local pGhost = CreatureObject(pPlayer):getPlayerObject()
