...
includeFile("outfits/hondo_outfit.lua")
includeFile("outfits/sabine_wren_outfit.lua")
includeFile("outfits/boba_fett_tusken_outfit.lua")
includeFile("outfits/the_armorer_outfit.lua")
includeFile("outfits/heat_outfit.lua")
includeFile("outfits/anakin_outfit.lua")
includeFile("outfits/clone_outfit.lua")
includeFile("outfits/cin_drallig_outfit.lua")
includeFile("outfits/luke_outfit.lua")