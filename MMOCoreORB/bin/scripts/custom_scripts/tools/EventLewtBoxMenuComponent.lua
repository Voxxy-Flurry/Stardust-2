...
function EventLewtBoxMenuComponent:fillObjectMenuResponse(pSceneObject, pMenuResponse, pPlayer)
...
function EventLewtBoxMenuComponent:handleObjectMenuSelect(pSceneObject, pPlayer, selectedID)
